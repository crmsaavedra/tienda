...
import { useCartStore, useAuthStore, useConfigStore, useWishlistStore } from '../store/store';
    ...
    <header className="w-full flex flex-col font-sans">
      ...
      <div className="bg-slate-800 text-slate-300 text-xs py-1.5 hidden md:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-end gap-6">
          <Link to="#" className="hover:text-white transition-colors">Nuestras Tiendas</Link>
          <Link to="#" className="hover:text-white transition-colors">Seguimiento Pedidos</Link>
          <Link to="#" className="hover:text-white transition-colors">Talleres Registrados</Link>
          <Link to="#" className="hover:text-white transition-colors">Venta Empresas</Link>
        </div>
      </div>
      ...
      <div className="bg-white border-b border-slate-100 py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4 lg:gap-8">
          ...
          <div className="flex items-center gap-4 lg:gap-6">
            ...
            <div className="hidden lg:flex flex-col items-center justify-center text-slate-600 cursor-pointer hover:text-primary transition-colors">
            ...
            <div className="hidden lg:flex flex-col items-center justify-center text-slate-600 cursor-pointer hover:text-primary transition-colors">
              ...
              <span className="text-[10px] font-bold uppercase">Mi Vehículo</span>
            </div>
