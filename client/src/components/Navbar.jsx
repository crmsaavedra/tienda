      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-6">
            <Link to="/favoritos" className="text-slate-500 hover:text-primary transition-colors relative">
          ...
          <div className="-mr-2 flex items-center sm:hidden">
            <Link to="/favoritos" className="p-2 text-slate-400 hover:text-slate-500 relative mr-1">
              <Heart className="w-6 h-6" />
              {wishlist.ids.length > 0 && (
        ...
        {isMenuOpen && (
          ...
          >
            <div className="pt-2 pb-3 space-y-1">
              ...
              <Link to="/favoritos" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-slate-600 hover:text-slate-800 hover:bg-slate-50">Mis Favoritos{wishlist.ids.length > 0 ? ` (${wishlist.ids.length})` : ''}</Link>
              {user ? (
                <>
