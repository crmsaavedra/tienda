          ...
          <div className="lg:col-span-7">
            ...
            {user ? (
              ...
              <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 text-center">
                <h3 className="text-lg font-bold text-slate-900 mb-2">Inicia sesión para continuar</h3>
                <p className="text-slate-600 mb-4">Debes estar registrado para finalizar tu compra de forma segura.</p>
                <Link to="/login" state={{ from: '/checkout' }} className="inline-flex items-center px-4 py-2 bg-primary text-white font-medium rounded-md hover:bg-orange-600 transition-colors">
                  Iniciar sesión o Registrarse <ChevronRight className="w-4 h-4 ml-1" />
                </Link>
              </div>
            )}
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 sticky top-24">
              ...
              <div className="p-6">
                ...
                <button 
                  ...
                  className="w-full bg-[#009ee3] hover:bg-[#0089c7] text-white font-bold py-4 px-4 rounded-md transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {isProcessing ? (
                ...
                <p className="text-xs text-slate-500 text-center mt-4 flex items-center justify-center gap-1">
                  <Shield className="w-3 h-3" /> Pago 100% seguro
                </p>
              </div>
            </div>
          </div>
