...
const seedData = async () => {
  try {
    ...
    await SiteConfig.create({
      banners: [
        {
          imageUrl: 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=1920&q=80',
    ...
    const parts = await Part.insertMany([
      {
        ...
        image: 'https://images.unsplash.com/photo-1596700140280-9b43ed5ba7f6?auto=format&fit=crop&w=800&q=80'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1620054707261-2e68fbdbdfaf?auto=format&fit=crop&w=800&q=80'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1542282088-72c9c2d2ed40?auto=format&fit=crop&w=800&q=80'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1619623667554-46c591b359f4?auto=format&fit=crop&w=800&q=80'
      },
      {
        ...
        compatibility: [],
        image: 'https://images.unsplash.com/photo-1616789953932-a5e2f3d640fa?auto=format&fit=crop&w=800&q=80'
      },
      {
        ...
        compatibility: [],
        image: 'https://images.unsplash.com/photo-1623910385966-7b43b664d4b1?auto=format&fit=crop&w=800&q=80'
      },
      {
        ...
        compatibility: [],
        image: 'https://images.unsplash.com/photo-1549487920-ca5d762e1281?auto=format&fit=crop&w=800&q=80'
      }
    ]);
    ...
    const order1 = new Order({
      ...
      deliveryMethod: 'delivery', trackingNumber: ''
    });
    ...
    const order2 = new Order({
      ...
      status: 'dispatched', paymentId: 'PAY-54321', paymentStatus: 'approved',
      deliveryMethod: 'delivery', trackingNumber: 'STARKEN-987654321'
    });
